...
public class UserGlobalsAndPanelFactory extends AbstractReLogoGlobalsAndPanelFactory{
	public void addGlobalsAndPanelComponents(){
		...
		addSliderWL("g","Gravitational Constant (g)",0.1,0.1,10.0,1.0)
		addSliderWL("massOfSun","Mass of Solar System's Sun",1,1,100,50)
		addSliderWL("planetXVel","X Velocity of Solar System's Planet",0,0.01,5.0,1.0)
		addSliderWL("planetSunDist","Distance of Solar System's Planet from Sun",0,0.01,15.0,10.0)
