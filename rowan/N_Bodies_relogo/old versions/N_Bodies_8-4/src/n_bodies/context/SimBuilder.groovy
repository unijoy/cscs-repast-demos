...
import n_bodies.relogo.UserLink;
import n_bodies.relogo.UserObserver;
import n_bodies.relogo.UserPatch;
import n_bodies.relogo.UserTurtle;
...
//		RLWorldDimensions rLWorldDimensions = new RLWorldDimensions(minPxcor, maxPxcor, minPycor, maxPycor);
		RLWorldDimensions rLWorldDimensions = new RLWorldDimensions(minPxcor, maxPxcor, minPycor, maxPycor, new StickyBorders());
