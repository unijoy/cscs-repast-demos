...
public class Boid {
	...
	/*
	/**
	 * Moves the calling Boid object an amount in the direction of the Boid's current heading.
	 * @param distance
...
//		angle2 = Math.toDegrees(angle2);
	...
	/**
	 * Returns the direction opposite to the one passed it, in degrees.
	 * @param angle--a direction in degrees
	 * @return the opposite direction as angle in degrees
	 */
	...
	/*
	 * Moves the calling Boid some amount away from a direction.
	 * @param direction--the direction to move away from
	 * @param dist--the amount to move the Boid
